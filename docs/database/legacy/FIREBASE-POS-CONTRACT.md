# Legacy Firebase POS contract — do not use for Supabase

Historical reference only. The current signing format, key headers, responses and validation behavior are documented in `../POS-CONTRACT.md`.
